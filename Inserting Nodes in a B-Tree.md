...
## OUTPUT
<img width="433" height="148" alt="image" src="https://github.com/user-attachments/assets/6d806289-548d-4fd8-83fc-fc14758e3fbd" />


## RESULT
  Thus the function `def insert(self, k):` to insert the nodes in a **B-Tree** is successfully verified.
