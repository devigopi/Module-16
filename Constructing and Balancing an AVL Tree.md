...
## OUTPUT
<img width="1392" height="171" alt="Screenshot 2025-11-22 215442" src="https://github.com/user-attachments/assets/2d5450b5-514a-43d5-ad48-20c3ea3e40c7" />


## RESULT
  Thus the program to construct an **AVL tree**, balance it, and print the nodes **before and after balancing** using the appropriate packages and built-in function is successfully verifoed.
