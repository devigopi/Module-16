...
## OUTPUT
<img width="722" height="357" alt="image" src="https://github.com/user-attachments/assets/0c441ffa-1498-4a64-8e5f-9d91349a770b" />


## RESULT
  Thus the function `def insert(self, key, value):` to insert elements into a **B+ Tree** is successfully verified.
